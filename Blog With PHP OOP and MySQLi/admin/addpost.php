    ...
    <?php  
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            if ($title=="" || $cat=="" || $body=="" || $tags=="" || $author=="" || $file_name=="") {
                ...
                $query="INSERT INTO tbl_post(cat,title,body,image ,tags,author,userid) 
                VALUES('$cat','$title','$body','$upload_image','$tags','$author','$userid')";
                $inserted_rows=$db->insert($query);
                if($inserted_rows){
                    echo "<span class='success'>Data Inserted Successfuly.</span>";
                }else{
